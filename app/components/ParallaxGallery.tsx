    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(col1Ref.current, {
        ...
        scrollTrigger: {
          ...
          start: "top bottom", // Анимация начинается, когда верх секции появляется снизу экрана
          end: "bottom top",   // И заканчивается, когда низ секции уходит за верх экрана
          scrub: true,         // Плавная привязка к колесику мыши
        }
      });
